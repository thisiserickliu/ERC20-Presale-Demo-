...
export function PresaleInfo({ presaleInfo }: PresaleInfoProps) {
  if (!presaleInfo) {
    return null
  }
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {format(presaleInfo.presaleStart * 1000, 'MMM dd, yyyy HH:mm')}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">End Date:</span>
              <span className="font-medium">
                {format(presaleInfo.presaleEnd * 1000, 'MMM dd, yyyy HH:mm')}
              </span>
            </div>
            <div className="flex justify-between">
